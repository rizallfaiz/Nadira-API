...
class HospitalController extends Controller
{
    function store(Request $request)
    {
        ...
        if ($object) {
            return response()->json([
                'http_response' => 200,
                'status' => 1,
                'message_id' => 'Berhasil Menambah Rumah Sakit',
                'message' => 'Berhasil Menambah Rumah Sakit',
                'object' => $object
            ]);
        } else {
            return response()->json([
                'http_response' => 400,
                'status' => 0,
                'message' => 'Gagal Menambah Rumah Sakit',
                'object' => $object
            ]);
        }
    }
    ...
    public function fetch()
    {
        ...
        return response()->json([
            ...
            'status' => 1,
            'length' => $object->count(),
            'message' => 'Berhasil Menampilkan Data Rumah Sakit',
            'data' => $object
        ]);
    }
    public function getByID($id)
    {
        ...
        return response()->json([
            'http_response' => 200,
            'status' => 1,
            'message' => 'Berhasil Menampilkan Detail Rumah Sakit',
            'data' => $object
        ]);
    }
